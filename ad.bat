...
echo                  ^|[32m                                                               [0m^|
echo                  ^|[32m      [5] Chunk Video Downloader                               [0m^|
echo                  ^|[32m                                                               [0m^|
echo                  ^|[32m      [6] GDrive File Handle(Download, Upload, Delete)         [0m^|
echo                  ^|[32m                                                               [0m^|
echo                  ^|[32m      [7] Spotify Downloader                                   [0m^|
echo                  ^|[32m                                                               [0m^|
...
echo.
echo.
echo [1mEnter choice [0/1/2/3/4/5/6/7/8/a/b/c][0m
set /p choice="Choice: "
echo.
...
if /I "[%choice%]"=="[5]" goto :ck
if /I "[%choice%]"=="[6]" goto :gd
if /I "[%choice%]"=="[7]" goto :spotd
...
yt-dlp --external-downloader aria2c --no-warnings --allow-unplayable-formats --no-check-certificate -F %check1%
...
yt-dlp --external-downloader aria2c --no-warnings --allow-unplayable-formats --no-check-certificate -F %mpd%
set /p ad=Enter audio id here :
yt-dlp -o "%UserProfile%/videos/cdncache/encrypted_audio.m4a" --no-warnings --external-downloader aria2c --allow-unplayable-formats --no-check-certificate --console-title -f %ad% %mpd%
ffmpeg -decryption_key %hex% -i "%UserProfile%/videos/cdncache/encrypted_audio.m4a" -codec copy "%UserProfile%/videos/cdncache/decrypted_audio.m4a"
...
yt-dlp -o "%UserProfile%/videos/cdncache/encrypted_video.mp4" --no-warnings --external-downloader aria2c --allow-unplayable-formats --no-check-certificate --console-title -f %vd% %mpd%
ffmpeg -decryption_key %hex% -i "%UserProfile%/videos/cdncache/encrypted_video.mp4" -codec copy "%UserProfile%/videos/cdncache/decrypted_video.mp4"
move %UserProfile%/videos/cdncache/decrypted_audio.m4a" "%UserProfile%/downloads"
...
yt-dlp -o "%UserProfile%/videos/cdncache/encrypted_video.mp4" --no-warnings --external-downloader aria2c --allow-unplayable-formats --no-check-certificate --console-title -f %vd% %mpd%
cd
yt-dlp -o "%UserProfile%/videos/cdncache/encrypted_audio.m4a" --no-warnings --external-downloader aria2c --allow-unplayable-formats --no-check-certificate --console-title -f %ad% %mpd%                                              [0m
mp4decrypt --key %kid%:%hex% "%UserProfile%/videos/cdncache/encrypted_video.mp4" "%UserProfile%/videos/cdncache/decrypted_video.mp4"
mp4decrypt --key %kid%:%hex% "%UserProfile%/videos/cdncache/encrypted_audio.m4a" "%UserProfile%/videos/cdncache/decrypted_audio.m4a"
ffmpeg -i "%UserProfile%/videos/cdncache/decrypted_video.mp4" -i "%UserProfile%/videos/cdncache/decrypted_audio.m4a" -y -acodec copy -vcodec copy "%UserProfile%/videos/cdncache/output.mp4"
...
cd
yt-dlp -o "%UserProfile%/videos/cdncache/encrypted_audio.m4a" --no-warnings --external-downloader aria2c --allow-unplayable-formats --no-check-certificate --console-title -f %ad% %mpd%
ffmpeg -decryption_key %kid% -i "%UserProfile%/videos/cdncache/encrypted_video.mp4" -codec copy "%UserProfile%/videos/cdncache/decrypted_video.mp4"
ffmpeg -decryption_key %hex% -i "%UserProfile%/videos/cdncache/encrypted_audio.m4a" -codec copy "%UserProfile%/videos/cdncache/decrypted_audio.m4a"
ffmpeg -i "%UserProfile%/videos/cdncache/decrypted_video.mp4" -i "%UserProfile%/videos/cdncache/decrypted_audio.m4a" -y -acodec copy -vcodec copy "%UserProfile%/videos/cdncache/output.mp4"
move %UserProfile%/videos/cdncache/output.mp4 "%UserProfile%/downloads"
ren "%UserProfile%/downloads/output.mp4" "%UserProfile%/downloads/%name%.mp4"
...
yt-dlp -o "%UserProfile%/videos/cdncache/encrypted_video.mp4" --no-warnings --external-downloader aria2c --allow-unplayable-formats --no-check-certificate --console-title -f %vd% %mpd%
cd
yt-dlp -o "%UserProfile%/videos/cdncache/encrypted_audio.mp4" --no-warnings --external-downloader aria2c --allow-unplayable-formats --no-check-certificate --console-title -f %ad% %mpd%
set /p kid=Enter kid key: 
set /p hex=Enter hex Key:
mp4decrypt --key %kid%:%hex% "%UserProfile%/videos/cdncache/encrypted_video.mp4" "%UserProfile%/videos/cdncache/decrypted_video.mp4"
...
ffmpeg -i "%UserProfile%/videos/cdncache/decrypted_audio1.mp4" -vn -ar 44100 -ac 2 -b:a %bit%k "%UserProfile%/videos/cdncache/decrypted_audio.mp3"
ffmpeg -i "%UserProfile%/videos/cdncache/decrypted_video.mp4"-i "%UserProfile%/videos/cdncache/decrypted_audio.mp3" -y -acodec copy -vcodec copy "%UserProfile%/videos/cdncache/output.mp4"
move "%UserProfile%/videos/cdncache/output.mp4" "%UserProfile%/downloads"
...
set /p hex=Enter audio Key:
set /p name= output video name :
yt-dlp --external-downloader aria2c --no-warnings --allow-unplayable-formats --no-check-certificate -F %vd%
set /p id1=Enter id here :
yt-dlp -o "%UserProfile%/videos/cdncache/encrypted_video.mp4" --no-warnings --external-downloader aria2c --allow-unplayable-formats --no-check-certificate --console-title -f %id1% %vd%
cd
yt-dlp --external-downloader aria2c --no-warnings --allow-unplayable-formats --no-check-certificate -F %ad%
set /p id2=Enter id here :
yt-dlp -o "%UserProfile%/videos/cdncache/encrypted_audio.m4a" --no-warnings --external-downloader aria2c --allow-unplayable-formats --no-check-certificate --console-title -f %id2% %ad%
mp4decrypt --key %kid%:%hex% "%UserProfile%/videos/cdncache/encrypted_video.mp4" "%UserProfile%/videos/cdncache/decrypted_video.mp4"
...
yt-dlp --external-downloader aria2c --no-warnings --allow-unplayable-formats --no-check-certificate -F %ad%
set /p id2=Enter id here :
yt-dlp -o "%UserProfile%/videos/cdncache/encrypted_audio.mp4" --no-warnings --external-downloader aria2c --allow-unplayable-formats --no-check-certificate --console-title -f %id2% %ad%
set /p kid=Enter kid key: 
set /p hex=Enter hex Key:
mp4decrypt --key %kid%:%hex% "%UserProfile%/videos/cdncache/encrypted_video.mp4" "%UserProfile%/videos/cdncache/decrypted_video.mp4"
mp4decrypt --key %kid%:%hex% "%UserProfile%/videos/cdncache/encrypted_audio.mp4" "%UserProfile%/videos/cdncache/decrypted_audio1.mp4"
...
yt-dlp --external-downloader aria2c --no-warnings --allow-unplayable-formats --no-check-certificate -F %yt1%
set /p vd=Enter id :
set /p reu=Enter name :
set /p ty=Enter the file type wich shows with id :
yt-dlp -o "%UserProfile%/downloads/%reu%.%ty%" --no-warnings --external-downloader aria2c --allow-unplayable-formats --no-check-certificate --console-title -f %vd% %yt1%
echo [32mIf the video is successfully downloaded, it will be included in your downloads.
echo If not, check out what happened by above[0m
msg * Your process done.
echo __________________________________________________________________________________________________
...
yt-dlp --external-downloader aria2c --no-warnings --allow-unplayable-formats --no-check-certificate -F %mpdr%
set /p vdr=Enter video here :
set /p vdr1=Enter video type:
set /p adr=Enter audio here :
set /p adr1=Enter audio type:
yt-dlp -o %UserProfile%/videos/cdncache/ev.%vdr1% --no-warnings --external-downloader aria2c --allow-unplayable-formats --no-check-certificate --console-title -f %vdr% %mpdr%
cd
yt-dlp -o %UserProfile%/videos/cdncache/ea.%adr1% --no-warnings --external-downloader aria2c --allow-unplayable-formats --no-check-certificate --console-title -f %adr% %mpdr%
echo * You can use low bit rate to speed up (kbs)                                                        
echo *                  8   16  32   64   128     256    320                                            
echo *                  low quality  normal     high quality                                             
echo *                  High speed   normal      low speed  [0m                                           
set /p bit=Enter bit rate of sound:
ffmpeg -i %UserProfile%/videos/cdncache/ea.%adr1% -vn -ar 44100 -ac 2 -b:a %bit%k %UserProfile%/videos/cdncache/ea1.mp3
ffmpeg -i %UserProfile%/videos/cdncache/ev.%vdr1% -i %UserProfile%/videos/cdncache/ea1.mp3 -y -acodec copy -vcodec copy %UserProfile%/videos/cdncache/output1.mp4
...
yt-dlp --external-downloader aria2c --no-warnings --allow-unplayable-formats --no-check-certificate -F %mpd4%
set /p vd=Enter video id here :
set /p vd1=Enter video type   :
set /p ad=Enter audio id here :
set /p ad1=Enter audio type   :
yt-dlp -o %UserProfile%/videos/cdncache/ev.%vd1% --no-warnings --external-downloader aria2c --allow-unplayable-formats --no-check-certificate --console-title -f %vd% %mpd4%
cd
yt-dlp -o %UserProfile%/videos/cdncache/ea.%ad1% --no-warnings --external-downloader aria2c --allow-unplayable-formats --no-check-certificate --console-title -f %ad% %mpd4%
ffmpeg -i %UserProfile%/videos/cdncache/ev.%vd1% -i %UserProfile%/videos/cdncache/ea.%ad1% -y -acodec copy -vcodec copy %UserProfile%/videos/cdncache/output.mp4
move %UserProfile%/videos/cdncache/output.mp4 "%UserProfile%/downloads"
set /p name= Change the name of video:
...
yt-dlp --external-downloader aria2c --no-warnings --allow-unplayable-formats --no-check-certificate -F %ytn%
...
yt-dlp -o %UserProfile%/videos/cdncache/a2e.m4a --no-warnings --external-downloader aria2c --allow-unplayable-formats --no-check-certificate --console-title -f %vdme% %ytn%
ffmpeg -i %UserProfile%/videos/cdncache/a2e.m4a -ar 44100 -ac 2 -b:a %q8%k "%UserProfile%/downloads/%n9%.mp3"
...
set /p vd=Enter id :
yt-dlp --no-warnings --external-downloader aria2c --allow-unplayable-formats --no-check-certificate --console-title -f %vd% %yt1%
echo [32mIf the video is successfully downloaded, it will be included in your downloads.
echo If not, check out what happened by above[0m
msg * Your process done.
echo __________________________________________________________________________________________________
...
yt-dlp --no-warnings --no-check-certificate -x --audio-format %yt3% --audio-quality %yt4% --external-downloader aria2c --add-metadata --embed-thumbnail --parse-metadata FROM:TO %yt2%
cd ..
echo __________________________________________________________________________________________________
echo 1 - Download Another one.
echo 2 - Go Back to "Youtube Downloader"
...
echo  * 720p - 22 [0m        
set /p vd=Enter id :
yt-dlp --no-warnings --external-downloader aria2c --console-title -f %vd% %yt5%
echo [32mIf the video is successfully downloaded, it will be included in your downloads.
echo If not, check out what happened by above[0m
echo __________________________________________________________________________________________________
echo 1 - Download Another one.
...
yt-dlp --external-downloader aria2c --no-warnings --allow-unplayable-formats --video-password %ytw% --no-check-certificate -F %yt1%
set /p vd=Enter id :
set /p reu=Enter name :
set /p ty=Enter the file type wich shows with id :
yt-dlp -o "%UserProfile%/downloads/%reu%.%ty%" --no-warnings --external-downloader aria2c --allow-unplayable-formats --video-password %ytw% --no-check-certificate --console-title -F %vd% %yt1%
echo [32mIf the video is successfully downloaded, it will be included in your downloads.
echo If not, check out what happened by above[0m
msg * Your process done.
echo __________________________________________________________________________________________________
...
echo                    ____________________________________________________________
echo                   ^|                                                            ^|
echo                   ^|                   Chunk Video Downloader                   ^|
echo                   ^|____________________________________________________________^|
echo.
echo [31m## This one is in under developing.[0m
set /p ur1=Enter url here :
ffmpeg -i %ur1% -c copy -f segment -segment_time 1800 %UserProfile%/downloads/outputchunkdownvid.mp4
echo [32mIf the video is successfully downloaded, it will be included in your downloads.
echo If not, check out what happened by above[0m
msg * Your process done.
echo __________________________________________________________________________________________________
